...
import com.jpble.R;
import com.jpble.activity.MapsActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            sendNotification(DateUtil.getCurrDate(FORMAT_ONE), "Vibration was sensed with “My GEO”", remoteMessage.getData().get("dataId"));
