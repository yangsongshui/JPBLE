...
public class RegisterModelImp extends BaseModel implements RegisterModel<Code>{
    ...
    @Override
    public void loadRegister(String url, Map<String ,String> map, final IBaseRequestCallBack<Code> iBaseRequestCallBack) {
        mCompositeSubscription.add(serviceApi.register(url,map)
