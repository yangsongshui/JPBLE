...
public class DeviceModelImp extends BaseModel{

    private Context context;
    private ServiceApi serviceApi;
    private CompositeSubscription mCompositeSubscription;

    public DeviceModelImp(Context mContext) {
        super();
        context = mContext;
    ...
    public void loadCode(String token , final IBaseRequestCallBack<Device> iBaseRequestCallBack) {
        mCompositeSubscription.add(serviceApi.getDevice(token)
