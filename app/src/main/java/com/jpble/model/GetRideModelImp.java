...
public class GetRideModelImp extends BaseModel {

    private Context context = null;
    private ServiceApi serviceApi;
    private CompositeSubscription mCompositeSubscription;

    public GetRideModelImp(Context mContext) {
        super();
        context = mContext;
    ...
    public void loadCode(  String token, final IBaseRequestCallBack<DeviceInfo> iBaseRequestCallBack) {
        mCompositeSubscription.add(serviceApi.getRide( token)
                ...
                .subscribe(new Subscriber<DeviceInfo>() {
                    ...
                    @Override
                    public void onNext(DeviceInfo msg) {
