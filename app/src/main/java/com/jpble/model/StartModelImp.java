...
public class StartModelImp extends BaseModel {

    private Context context = null;
    private ServiceApi serviceApi;
    private CompositeSubscription mCompositeSubscription;

    public StartModelImp(Context mContext) {
        super();
        context = mContext;
    ...
    public void loadCode(String url, String token, String lockId, final IBaseRequestCallBack<Code> iBaseRequestCallBack) {
        mCompositeSubscription.add(serviceApi.startRide(url, token, lockId)
