...
public class DeleteModelImp extends BaseModel {

    private Context context = null;
    private ServiceApi serviceApi;
    private CompositeSubscription mCompositeSubscription;

    public DeleteModelImp(Context mContext) {
        super();
        context = mContext;
    ...
    public void loadCode(String url, String lockId, String token, final IBaseRequestCallBack<Code> iBaseRequestCallBack) {
        mCompositeSubscription.add(serviceApi.delete(url, lockId, token)
