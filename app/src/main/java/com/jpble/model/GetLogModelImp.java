...
public class GetLogModelImp extends BaseModel {

    private Context context = null;
    private ServiceApi serviceApi;
    private CompositeSubscription mCompositeSubscription;

    public GetLogModelImp(Context mContext) {
        super();
        context = mContext;
    ...
    public void loadCode(String token, final IBaseRequestCallBack<LogInfo> iBaseRequestCallBack) {
        mCompositeSubscription.add(serviceApi.getLog(token)
                ...
                .subscribe(new Subscriber<LogInfo>() {
                    ...
                    @Override
                    public void onNext(LogInfo msg) {
