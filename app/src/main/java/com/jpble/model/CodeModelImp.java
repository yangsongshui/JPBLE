...
public class CodeModelImp extends BaseModel{
    ...
    public CodeModelImp(Context mContext) {
        super();
        context = mContext;
    ...
    public void loadCode(String email , final IBaseRequestCallBack<Code> iBaseRequestCallBack) {
        mCompositeSubscription.add(serviceApi.getCode(email)
