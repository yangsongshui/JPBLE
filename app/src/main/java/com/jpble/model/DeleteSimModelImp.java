...
public class DeleteSimModelImp extends BaseModel {

    private Context context = null;
    private ServiceApi serviceApi;
    private CompositeSubscription mCompositeSubscription;

    public DeleteSimModelImp(Context mContext) {
        super();
        context = mContext;
    ...
    public void loadCode(String url, String cardId, String token, final IBaseRequestCallBack<Code> iBaseRequestCallBack) {
        mCompositeSubscription.add(serviceApi.deleteSim(url, cardId, token)
